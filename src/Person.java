...
public class Person
{
  ...
  // line 35 "model.ump"
   public static  void main(String [] args){
    ...
    Student s2 = new Student("Cat The Student");
    Student s3 = new Student("Crow The Student");
    Student s4 = new Student("Cow The Student");
    Student s5 = new Student("Hen The Student");
    Student s6 = new Student("Snake The Student");
    ...
    System.out.println("The mentor of "  + s6  + " is " +  s6.getMentor());
